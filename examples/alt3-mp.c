...
// Alternation with consumer and two producers
// with one producer on another processor
...
{
    printf("alt2-mp: alternation with consumer and two producers,\n");
    printf("with one producer on a different processor\n");
    ...
    placed_par(children, args, stacksize, place, 3);
    printf("After par\n");
